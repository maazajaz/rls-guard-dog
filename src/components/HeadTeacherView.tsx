...
export default async function HeadTeacherView() {
  ...
  // The RLS policy will automatically filter the progress reports for the head teacher's school.
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">School-wide Progress</h2>
      {progress.length === 0 ? (
        <p>No progress reports found for your school.</p>
      ) : (
